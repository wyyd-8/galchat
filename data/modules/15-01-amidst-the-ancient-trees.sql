...
图书馆和《本宁顿旗帜报》档案无需检定即可提供两组报道：南北战争逃兵曾把森林当作北逃加拿大的藏身地；斯特朗最近派地质勘探队前往未来水库河床寻找稀有矿藏。向镇民打听还能得知猎人避开森林中心、波士顿画家近日入山、卡车驶向北方，以及乔瑟夫·特纳鬼魂等流言。印第安墓地属于干扰信息。

【森林边缘与猎人遭遇】
森林边缘能找到哈里斯与克莱顿留下的足迹。追踪检定控制速度和遭遇优势，但失败不能切断主线，最终必须让队伍取得方向。
...
【第一夜】
林中营地基本安全。所有调查员进行POW检定；失败者随机获得一份梦唤材料并承受其效果。午夜聆听成功可听到远处卡车引擎声，或尤金·克莱顿射击路过仆从的步枪声。执意夜行需困难CON，失败者困倦得无法继续。$text$
        ),
        (
            v_module_id,
            '第二天场景',
            '深入森林、画家尸体、勘探卡车、尤金·克莱顿与第二夜异变。',
            $text$第二天越深入森林，动物痕迹和声音越少。追踪失败的孤注一掷后果可选：黑熊、其他搜查队误射、差点被卡车撞上、落单仆从、遗失步枪或自然环境伤害；失败不能切断主线。

【画家尸体】
侦查成功可见一道横穿小路的血迹，追踪成功可见散乱落叶和折枝，表明有人负伤逃跑。沿血迹偏离主路约800米，会先发现一把古旧、锈蚀且沾血的猎刀，再发现一名衣服染有颜料的男尸。未习惯死亡者见其惨状损失0/1D3 SAN。死者没有身份证件，侧腹刀伤被草率包扎。医学或急救成功可判断他持续失血约一天后死亡。沿血迹反向追踪需耗费当天余下大部分时间，最终抵达画家营地。

【勘探卡车】
地面深轮迹蜿蜒向东北，导航成功可判断它通往萨默赛特以北。随后驶来的卡车由刚被转化的工程师詹姆斯·斯坦顿驾驶。他胸口有格拉基脊刺留下的伤口，以外套遮住；他冷漠、敌视但仍能正常交谈和欺骗。斯坦顿反对搜车却不会立刻动武。车上没有逃犯，只有数箱炸药。他声称自己受斯特朗指示进行地质勘探，领班是卡尔·怀特；听说附近有人时会显得格外关注。他不会主动载人去营地，却会指明沿轮迹直走即可抵达挖掘现场。

【尤金·克莱顿】
临近黄昏，困难侦查成功可看见步枪瞄准镜反光；团体幸运决定克莱顿是否先发现队伍。若占先，他会朝头顶鸣枪警告，此后只剩三发子弹。调查员可隐蔽，潜行成功才能安全接近；正面暴露进攻会遭实弹射击。克莱顿因警察霰弹枪伤势，攻击与追逐检定都承受一颗惩罚骰。

弹药耗尽或调查员逼近后，他会逃而非死战。追逐可经过泥坡、溪流和灌木，需要攀爬、跳跃、DEX、侦查或追踪。被捕后，尤金·克莱顿投降并要求医疗。他发烧且恐惧，声称前夜明明击中一个人，对方却继续走动。他会把罪责推给哈里斯，确认枪战前珍妮仍健康，并给出多布斯看守珍妮的藏身小屋方位。

【第二夜】
所有调查员都会受到梦唤，不能再抽到“不眠之夜”。极限侦查成功可发现路易斯监视。路易斯试图回营报告，被逼入绝境时会借一次重击装死后逃走。午夜北方爆炸，云底短暂映出蓝光；随后一支被噩梦吓坏的搜查队会撤回镇上。$text$
        ),
        (
            v_module_id,
            '第三天场景',
            '画家营地、绑匪藏身小屋、特纳的小屋、黑湖湖畔与水晶挖掘现场。',
            $text$第三天临近湖区时，树林病态发黄且死寂，灌木也呈不自然的浅黄色。聆听成功者因意识到没有任何野生动物而损失0/1 SAN。

【画家营地】
营地靠近卡车路线。篝火已灭、帐篷破裂，现场有明显打斗痕迹。六名画家中一人负伤逃走并死在别处，另外五人被特纳一伙抓走。
...
侦查成功会在灌木中找到步枪与布莱恩的宽牛仔帽，旁边有朝北、通往挖掘现场的拖拽痕迹。这里可以继续追踪袭击者去湖畔，也可转向克莱顿提供的藏身处。

【绑匪藏身小屋】
空地中央是一座门窗紧闭的旧木屋。恶臭来自旁边浸血的树：克里斯托弗·多布斯被树枝贯穿胸膛挂在半空，目睹者损失0/1D4 SAN。木屋遍布由内向外射出的弹孔。西德尼·哈里斯因连续梦唤与仆从袭击陷入疯狂，持霰弹枪藏在屋内。听见靠近便开火，并喊“把她还回来”。除非被制服，或调查员通过极限说服、取悦、恐吓让他冷静，否则他会把来者都视作怪物持续射击。镇定后，他会说明自己回来时珍妮已失踪、多布斯已死，昨夜又有死人袭击木屋，随后彻底崩溃。

【特纳的小屋】
通往湖区的踪迹分成新旧两路：近期频繁使用的路去挖掘现场，黄叶覆盖的旧路经过特纳的小屋再到黑湖湖畔。做过“小径”或“小屋”梦境者认出实景时分别损失0/1或1/1D6 SAN。屋内有联邦军制服帽子、染血猎刀、悬挂的动物尸体和一支锈死的旧步枪。侦查成功可发现地板缝透出浅蓝光及通往土砌地下室的活板门。地下有五具发光蓝色石棺，老仆从白日休眠于此。

石棺中可找到南北战争时期私人物品、非地球金属质感的中空脊刺、带乔瑟夫·特纳名字的日记，以及无法辨识的绿色腐败粉尘。科学研究脊刺会因认识到其非地球性质损失0/1 SAN。日记记载逃兵在黑湖接受永生、格拉基被分散水晶囚禁，以及仆从必须把附近碎片送到湖中削弱牢笼。白天奥古斯特、雅各布睡在其中两具石棺。被惊醒后，他们先以永生诱骗调查员，若遭攻击或调查员欲离开才试图制服并塞进空棺。石棺魔法封闭，内外打开都需困难STR或POW，取较低者；孤注一掷失败可导致昏迷或梦境侵袭。两名仆从不会在白天追出小屋，但会在夜间追捕逃亡者。

【黑湖湖畔】
黄叶旧路抵达漆黑、恶臭、死寂的湖。五名幸存画家被绑在离岸约五米的柱上，胸前各插有约60厘米长的金属脊刺，满身血肉却仍活动。目睹惨状损失1/1D6 SAN，发现他们还活着再损失1/1D4。画家精神已毁，但能说明活尸把他们从营地抓到挖掘现场，那里还关着一个男人、男孩和女孩；仆从正在用工具与炸药从坑中取出某物；湖中怪物把刺插进他们体内。拔刺会让画家尖叫死亡并结束痛苦。随后进行团体幸运，失败则惊动詹姆斯和迪恩前来。

被仆从发现的调查员会被制服并送往储藏棚，或绑到湖边柱上。挣脱需困难STR或DEX。日落仍在柱上时，特纳一伙会召唤格拉基转化他们；未被解脱的画家将在午夜成为新仆从。若仆从成功运来水晶，格拉基从水中升起并汲取蓝色水晶的力量。目睹者按第十四章格拉基条目承受理智损失。破坏运送系统、打碎水晶、消灭工人或及时营救俘虏，都能延迟或阻止这一幕。

【水晶挖掘现场】
卡车路在五杆门处由理查德·吉布森把守。他能礼貌地假装普通工程师，以爆破危险为由拒绝公众进入。话术、说服、取悦或恐吓成功可获准见领班卡尔·怀特；失败被赶走，孤注一掷失败可能引来更多仆从并爆发冲突。空地中央是爆破大坑。卡尔、詹姆斯、迪恩在坑与工具棚间搬运绳索和设备。五间棚屋依次为：领班办公室（勘探图、实验设备、异常矿物及污染文件）；住宿棚；废弃厨房杂物棚；窗户封死、标作“储藏室”的俘虏牢房；存放钻机、工具和炸药的工具棚。

卡尔先用“发现铂金迹象”的半真解释安抚来客，再借参观把调查员引到第四棚屋。他声称展示矿样，实则让仆从关门，在黑暗中围捕。棚内关着珍妮、布莱恩与亚瑟。特纳、文森特、路易斯可能藏在隔壁避光，特纳会以支配术协助抓捕。俘虏能提供证词：珍妮说“死人”闯入绑匪小屋、把多布斯钉死并将她带走；布莱恩说他和亚瑟遇见画家后发现大家做相同梦，袭击者谈到与新神合一，画家随后被带走。被绑调查员解绳需困难DEX，高声交谈会被守卫听见；脱身后还需潜行穿过主房间。逃到日光下时，老仆从不会追出，但新转化勘探队会追杀。
