#!/usr/bin/env python3
"""Render a modern CoC investigator sheet from CharacterCardVO JSON."""
...
DEFAULT_TEMPLATE_DIR = ROOT / "character_card_templates"
SHEET_BACKGROUNDS = {
...
FONT_FILES = {
    0: ROOT / "fonts/ZCOOLXiaoWei-Regular.ttf",
    1: ROOT / "fonts/ZhiMangXing-Regular.ttf",
    2: ROOT / "fonts/MaShanZheng-Regular.ttf",
}
