...
<template>
  <main class="chat-page direct-chat-page">
    <header class="chat-header">
      ...
      <div class="chat-header-actions"><span class="live-status active"><i />{{ world.thinkStatus === false ? '即时陪伴' : '思考模式' }}</span><button class="button ghost" @click="emit('edit')"><Settings2 :size="16" />角色资料</button></div>
    </header>
